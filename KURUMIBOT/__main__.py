...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am an group management bot. I will use my Powers and protect your group. You can find my list of available commands with /help.
"""
...
For all command use / [or](https://telegra.ph/file/4f4e2acdda8da385012d8.jpg) ! 
""".format(
    dispatcher.bot.first_name, ""
    if not ALLOW_EXCL else "\nAll commands can either be used with / or !.\nKindly use ! for commands if / is not working\n")

TOKISAKI_IMG = "https://telegra.ph/file/2f725b59802b7e270ba15.jpg"
KURUMI_IMG = "https://telegra.ph/file/2f725b59802b7e270ba15.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Click here to donate in [PayTM](https://www.t.me/GodKiller_mArk2)"""
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="📳 Chat Group 📳",
                             url="https://t.me/THE_CHATTING_CHAMBER")
                    ]]))
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[My DEVS won't let me die!](https://telegra.ph/file/4f4e2acdda8da385012d8.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
